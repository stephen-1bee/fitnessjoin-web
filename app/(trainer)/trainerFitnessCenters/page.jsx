...
const Center = () => {
  ...
  const handleFitnessCenterClick = (centerId) => {
    if (typeof window !== "undefined" && window.sessionStorage) {
      sessionStorage.setItem("trainerCenterId", centerId)
    }

    window.location.href = "/trainerViewFitnessInfo"
  }
  ...
  return (
    <div className="bg-[#edf1f7] min-h-screen flex flex-col items-center gap-5 w-full">
      <div className="w-full h-[50vh] home flex flex-col justify-center items-center">
        <button className="text-white flex bg-[#08A88A] px-5 py-3 gap-1 rounded-full absolute top-3 right-[40px] cursor-pointer">
          <LocationOnOutlined />
          <h1>Near Me</h1>
        </button>
      ...
      {searchQuery ? (
        ...
        <>
          <h1 className="text-xl text-left font-bold">Recommended</h1>
                  ...
                  recommended.map((recommend) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundImage: `url(http://localhost:1000/${recommend.photo})`,
                          backgroundSize: "cover",
                          backgroundPosition: "center",
                        }}
                      >
