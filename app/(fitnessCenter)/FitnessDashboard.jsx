  ...
  return (
    <div className="flex justify-center gap-5">
      ...
      <div className="flex flex-wrap gap-5">
        ...
        {/* MEMBERSHIP */}
        <div className="flex w-[250px] items-center justify-between  px-10  h-[150px] shadow-lg rounded-lg bg-white">
          <div className="flex bg-green-100 rounded-full p-5 text-left">
            <CardMembership className="text-[18px]" />
          </div>
          <div className="flex flex-col text-left">
            ...
            {memberships.length === 1 ? (
              ...
              <p className="text-center">No Memberships</p>
            ) : (
              <p className="text-center">Memberships</p>
            )}
          </div>
        </div>
        {/*  USERS */}
